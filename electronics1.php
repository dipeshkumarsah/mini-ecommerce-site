...
$query = "SELECT * FROM electronics_second";
...
<head>
    ...
    <title>Electronics1 | SnapGross</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="home-prodlist">
            <div>
                <h3 style="text-align: center;">Electronic1</h3>
            </div>
            <table style="margin:0 auto;" class="table-data">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                    <tr>
                        ...
                        <td><?php echo $row['computer_memory_size']; ?></td>
                        <td><?php echo $row['screen_size']; ?></td>
                        <td><?php echo $row['hard_disk_size']; ?></td>
