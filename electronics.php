...
$query = "SELECT * FROM electronics_one";
...
<head>
    ...
    <title>Electronics | SnapGross</title>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="home-prodlist">
            <div>
                <h3 style="text-align: center;">Electronic</h3>
            </div>
            <table style="margin:0 auto;" class="table-data">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                    <tr>
                        ...
                        <td><?php echo $row['Wireless_carrier']; ?></td>
                        <td><?php echo $row['Colour']; ?></td>
                        <td><?php echo $row['Memory_storage_capacity']; ?></td>
